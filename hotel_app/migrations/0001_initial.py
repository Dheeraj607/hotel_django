# Generated by Django 3.1.7 on 2025-04-07 10:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintenanceType', models.CharField(choices=[('plumbing', 'Plumbing'), ('electricianing', 'Electricianing'), ('cleaning', 'Cleaning'), ('general_maintaining', 'General Maintaining')], max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roleId', models.ForeignKey(db_column='roleId', on_delete=django.db.models.deletion.CASCADE, related_name='staff_roles', to='hotel_app.maintenancestaffroles')),
